    ...
    <section className="bg-gradient-to-r from-gray-100 via-blue-50 to-gray-100 text-gray-800 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
          Master the markets with expert insights, proven strategies, and practical guidance. Your journey to trading success starts here.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
          <div className="bg-white/50 backdrop-blur-sm px-6 py-3 rounded-lg border border-gray-300 w-full sm:w-auto text-center">
            <span className="text-gray-800 text-sm sm:text-base">Latest insights on market trends</span>
          </div>
          <div className="bg-white/50 backdrop-blur-sm px-6 py-3 rounded-lg border border-gray-300 w-full sm:w-auto text-center">
            <span className="text-gray-800 text-sm sm:text-base">Expert trading strategies</span>
          </div>
        </div>
      </div>
    </section>
